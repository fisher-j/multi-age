...
TODO: Redwood and tanoak both are known to sprout vigorously following
disturbance. There are fire studies that have documented redwoods competitive
advantage. Its not clear if this study contradicts the often stated notion that
following disturbance, tanoak is a strong competitor with redwood, given our
observations of much larger redwood sprout response in the higher light
conditions. There is not a lot of information directly comparing the shade
tolerance of redwood and tanoak sprouts, but it is generally assumed that tanoak
is more shade tolerant than redwood [@waringRedwoodTanoakStand2008]. I need to
also remember that these stands were pre-commercially thinned twice.
...
levels of openness and the tanoak response was comparatively modest. Strong
redwood response to increasing light has been well documented
[@oharaDynamicsCoastRedwood2010;@berrillUnderstoryLightPredicts2018;@boeNaturalSeedlingsSprouts1975;@barrettModelThirdGrowth1988;@webbWhiskeySpringsLongterm2012].
Meanwhile, tanoak typically is relegated to a sub-canopy layer in these systems
[@oharaRegenerationDynamicsCoast2017].

The only statistically supported difference for tanoak was between the GS and HA
...
data not shown) and that this size class was assigned the possibly inaccurate
...
the HD treatment may be slightly artificially elevated. On the other hand, the
 difference between the HA and HD treatments was mirrored in the vegetation
...
objective to maintain conifer growth [@berrillSimulatingMultiagedCoast2009]. It seems likely that at higher overstory
...
::: {.callout-caution}
## TODO:
What about the potential effects of soil type
