...
Douglas-fir abundance was also modeled using stem counts because the species
...
in these systems if redwood sprout growth is to be maintained.
...
In a study across Sierra forests, fine fuel loading (including 1-, 10-, and
100-hr fuels) were found to be correlated with overstory canopy cover and
proportion of shade tolerant species and associated these conditions, which
represent recent shifts in forest composition resulting from fire suppression,
with an elevated risk of high severity fire
...
is a function of moisture and temperature (CITATIONS). Forest floor conditions
in the HA treatment may have been somewhat more moist than the more open
treatments (due to sheltering), but warmer than the HD treatment (due to greater
light infiltration). While the differences in duff & litter loading we observed
are not likely to have a significant impact on fire behavior, small differences
in forest floor moisture can have significant implications for prescribed
burning operations because these are often conducted under marginal conditions
(CITATIONS). 
...
travel through due to the amount of understory growth present in these
treatments. Our experience in the field was partially validated by our findings
of somewhat elevated basal area of tanoak and redwood in those treatments. 

In this study, live and dead components were combined because the focus was on
