...
notion that 20% relative density is a good target to promote redwood
...
The use of basal area as a response did not distinguish between number of stems
and size of stems. There have been numerous metrics used in attempts to assess
shade tolerance [@forresterResponseTreeRegeneration2014]. The use of basal area
(which conflates growth and survival of sprouts) is justified given the
assumption that these are expected to be correlated in forests that do not
...
growth [@berrillSimulatingMultiagedCoast2009]. 

Redwood growth in the understory---in terms of average total basal area of sprouts 10
...
any clear evidence for this threshold.

Average redwood sprout basal area 10 years after treatment was much more
dramatically affected by overstory density than tanoak. Each step increase in overstory
...
redwoods greater sensitivity to light conditions. We selected sites with both
north and south facing slopes and this may have led to relatively larger
differences for redwood growth response compared to tanoak. Additional
uncertainty may be due to variable light levels within macro plots.

The basal area comparisons between redwood and tanoak resulted in steadily
decreasing differences between these two species as overstory density increases.
This is in contrast to findings from this and other studies when the focus is
instead on sprout height growth. The inclusion of basal area here provides a
more complete picture of not only sprout vigor, but also has implications for
total biomass and fuel loading. 
...
Sampling included relatively few minor species and differences across
...
throughout the experiment results: such as for tanoak sprout basal area where
...
experiment, but were not detected with the current experimental design
[@mumaConvertingCoastRedwood2019].

### Douglas-fir seedling density

Douglas-fir abundance was modeled using stem counts because the species does not
...
When comparing the average fuel loadings found in this study to
those found in the "old growth" and "very young, mixed" stands referenced
above, the one-hr fuel loading which, which averaged about 1 Mg ha^-1^ was similar to
that found in the old-growth stand. However it was about half that found in the very young,
mixed stand, 
...
were not more clearly differentiated because the field crew's experience was
...
timespan before and after PCT. Second, the sampling protocol did not make it
...
Reducing uncertainty around redwood and tanoak sprout basal area may require
better incorporating the effect of aspect into the model. It also seems likely
that the effect of site on sprout growth was bi-modal (due to the combination of
predominately north- and south-facing site aspects) and thus the regularization
imposed by the random effects for sites (assumed to be normally distributed) was
likely inappropriate. These same concerns also apply to the models of vegetation
fuel loading, which was likely also affected by aspect.
...
might have led to better explanatory power in the models. The plots were
...
Improvements to the estimation of vegetation fuel loading, as well as
incorporating a method to quantify foliage loading in the slash fuels generated
during PCT, would be important to improve the coupling between pre-PCT
vegetation fuel loading and post-PCT fine fuel loading.
...
observed in fuel loads, it seems likely that those unmeasured factors may have
a greater bearing on fire outcomes and warrant further study in these complex,
endemic, managed forest systems. Similarly, because duff and litter have
different implications for fire behavior, reporting these separately would be an
important improvement to future work.

While this study recognizes the importance of incorporating Indigenous
