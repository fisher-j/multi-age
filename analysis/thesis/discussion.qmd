...
- Is the regularization imposed on my random effects for sites appropriate if
  the distribution of site effect is bi-modal because of north vs south facing
  aspects?
- Aspect is an important predictor that was not explicitly accounted for in my
...
* This study corroborated a range of findings from other studies regarding
  redwood response, tanoak response, fuel loading, and live fuel response to
  canopy openness.
* Contributed to a developing a comprehensive framework for studying
  silvicultural systems with regards to both regeneration and fuels, and the
  trade-offs between them.
* Clarifies the importance of meaningful consultation with Indigenous
  communities in the management of culturally important species such as tanoak,
  and the importance of integrating Indigenous fire stewardship with
  contemporary forest management.
* Develops a modeling framework that can be built upon in future work.
...
shade tolerance [@forresterResponseTreeRegeneration2014]. My use of basal area
...
tanoak abundance should exceed that of redwood. The general trends in my
results align with this theory, but my standard errors were too high to derive
...
development responses with varying overstory density. My results suggest that
...
species in each vegetation plot, this suggests that variability in redwood
understory basal
...
larger differences for redwood growth response compared to tanoak. Additional
...
has been found to play an important role in moderating growth beyond what
...
proxy for size of resprouting root system [@berrillUnderstoryLightPredicts2018].
...
counts. While my observed recruitment density of Douglas-fir
...
throughout my experiment results: such as for tanoak sprout basal area where
...
experiment, but were not detected with my current experimental design
...
will generally be the largest and most vigorous. My measurement of total height
...
basal area with my high-overstory-retention treatments, especially compared to
...
studies in redwood systems. My treatment level averages for duff and litter
...
as old-growth stands (average: 50 Mg ha^-1^) and my raw average duff and litter
...
separating the two resulted in little difference in average bulk density,
...
above, my one-hr fuel loading which, which averaged about 1 Mg ha^-1^ was similar to
...
supported by my finding of similar 1-hr fuel loading as in the old growth
...
between my stands and the old growth ones.
...
over from the harvest treatment that initiated my experiment which would have
...
The similarity in average fuel loading between my Pre-PCT stands and two
studies conducted in structurally distinct redwood forests aligns with my
...
were not more clearly differentiated because my field crew's experience was
...
timespan before and after PCT. Second, my sampling protocol did not make it
...
for fire informed management. In my experiment, greater overstory retention
...
Reducing my uncertainty around redwood and tanoak sprout basal area may require better
incorporating the effect of aspect into my model. Also regarding aspect, it
seems likely that the effect of site on sprout growth was bi-modal (due to my
combination of predominately north- and south-facing site aspects) and thus the
regularization imposed by my random effects for sites (assumed to be normally
distributed) was likely inappropriate. These same concerns also apply to my
modeling of vegetation fuel loading, which was likely also affected by aspect.
...
might have led to better explanatory power in my models. My plots were
...
Although the contribution of slash foliage is not accounted for, it appears my
...
endemic, managed forest systems.
...
A significant outcome of this research lies in its broader implications for
forest stewardship. This study recognizes the importance of incorporating
Indigenous perspectives—particularly those of the Northern Pomo, the original
stewards of these lands—into the responsible management of keystone species such
as tanoak. For millennia, Indigenous Californians actively shaped redwood–tanoak
