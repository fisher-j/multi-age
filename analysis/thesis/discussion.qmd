...
- Forest management for timber and other objectives and prescribed and wild fire
  ...
  fire dependent silviculture was a hallmark of traditional stewardship
  practices for tribes across northern California since time immemorial
  [@andersonTendingWildNative2013]. It has also been practiced and researched in
  the Southeastern U.S. for around 100 years. The American west has been slower
  to embrace this paradigm shift in thinking now termed "pyrosilviculture"
  [@northPyrosilvicultureNeededLandscape2021]. It is my hope that this thesis
  serve as an example of bridging the gap between the art and science of growing
  trees to support multiple uses and the thinning and burning practices
  typically regarded as "fuels management" activities
  [@yorkPyrosilvicultureCombiningPrescribed2021]. The ability to see envision
  these realms of understanding as integral and essential pieces of a common
  forest stewardship will lead to new insights in increase our capacity for
  better land management as a culture.
...
- Little is understood about tanoak sprout response under shade
  ...
  devlopment responses with varying overstory density.
