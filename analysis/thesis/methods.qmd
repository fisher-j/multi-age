...
Transect lengths for 1-, 10-, and 100-hr fuels were two, two, and four meters,
respectively during pre-PCT measurements. During post-PCT measurement, the
length of the 1-hr fuel transect was reduced to one meter because of the dramatic
increase in these fuels. Coarse woody fuels were measured along the entire 10-meter
transect.
...
efforts were made to compare these frequently to ensure that estimates among
...
used in our study. Notably, our population estimates assume equal proportions of
north and south facing aspects.

::: {.callout-caution}
TODO:@heissMarginalConditionalEffects2022

* Try to use terminology for conditional and marginal predictions described in
  @heissMarginalConditionalEffects2022
* I would like to write my models in formal notation similar to
  @heissMarginalConditionalEffects2022:
  $$
  \begin{aligned}
...
Sprout count data from our 4-meter-radius regeneration plots were converted to
