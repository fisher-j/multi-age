...
basal area in HD compared to HA (p = 0.014, @fig-regen-ba).
...
is expected to be 1.4 times that of tanoak (p = 0.56). The variability,
indicated by the 95% confidence intervals, is much greater than that of tanoak's
across treatments.
...
(@fig-fuel-post-pct). One-hour fuels were
