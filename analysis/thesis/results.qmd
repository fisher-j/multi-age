...
support that treatments affected species basal area growth differentially. This
was true for species individually and when considered together (data not shown).
...
@fig-regen-ba-rw-to highlights the rapid decline in redwood basal area relative
to tanoak with increasing overstory retention. It also illustrates the greater
uncertainty associated with redwood basal area in the GS treatment, as reflected
by the wider confidence intervals compared to those of tanoak.
