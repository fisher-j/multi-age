...
than tanoak basal area in the GS treatment (p = `r
rw_to_pairs$gs[[1]]$p.value`), about `r abs(rw_to_pairs$ld[[1]]$estimate)` m^2^
...
higher tanoak basal area (`r abs(rw_to_pairs$hd[[1]]$p.value)`).
