...
## {background-image="../figures/site_map_2.png" background-size="contain"}
...
## In 2012 we harvested 16 one-hectare blocks using different harvest treatments{.smaller}
...
:::{.columns}
:::{.column}
![Sampling cylinders](../figures/samp_cyl.png)
:::
:::{.column}
![A fuel transect](../figures/transect.jpg)
:::
:::
...
1. [Implement experiment]{style="opacity: 50%"}
1. [Establish plots and transects]{style="opacity: 50%"}
1. **Sample sprout heights, regen. densities, and fuels**
1. [Model sprout heights, report densities, model fuels]{style="opacity: 50%"}
...
:::: {.columns}
:::{.column width=60%}
We estimated percent cover and average height for standing vegetation in four classes:

- Green (wet) herbaceous
- Dry (brown) herbaceous
- Green (wet) woody
- Dry (brown) woody
:::
...
1. [Implement experiment]{style="opacity: 50%"}
1. [Establish plots and transects]{style="opacity: 50%"}
1. [Sample sprout heights, regen. density, and fuels]{style="opacity: 50%"}
1. **Model sprout heights, report on regen., model fuels**
...
- slow down in growth rates is negligible across treatments
