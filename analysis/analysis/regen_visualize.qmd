...
rmse(m1, m2, m3, m4, m5a, m6, m6a, m7)
...
Use this graph to compare two models
...
avg_predictions(
  ...
  ggplot(aes(treat, estimate, color = model, group = model)) +
...
Here are the (would be) most significant contrasts between treatment, within
species.
...
TPH). I was not able to achieve model convergence with the specification of zero
