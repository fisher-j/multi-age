...
regen_pa |>
  mutate(simulate(mba_sel, nsim = 5)) |>
  rename(obs = ba_ha) |>
...
emmeans(mba_sel, c("spp", "treat"), by = "spp", type = "response") |>
...
save(regen, spp_col, per_ha, for_const, mba_sel, regen_pa, mdf_sel, regen_df, file = "regen_visualize.rda")
