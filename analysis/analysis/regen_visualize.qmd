...
of my analysis. These differences have already been visualized above.
...
A negative binomial model seems to fit acceptably. I was not able to achive
model convergence with the specification of zero inflation or dispersion
formulae.
...
TODO: pairwise adonis may be available:
