...
The first models don't include the site as strata. When I put site in the model,
p-values increase slightly.

If I include site in strata, then it doesn't seem to matter if I put in in the
model or not.
