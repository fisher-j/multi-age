...
minc11cld <- cld(minc11em, Letters = letters) |> as_tibble() |> mutate(.group = str_replace_all(.group, " ", ""))
...
#| fig-cap: >
#|   Mean and 95% confidence interval for model `mht104`, displayed with raw
