...
```{r}
#| label: fig-raw-data
#| fig-cap: Two outliers were removed to aide in interpretability--600 and 199
#|   t/ha in ha-thoushr and gs-veg, respectively.
...
```{r}
#| label: tbl-raw-data
#| tbl-cap: Average (sd) transect level load (Mg ha^-1^) for six fuel class categories in
#|   four different overstory harvest techniques.
